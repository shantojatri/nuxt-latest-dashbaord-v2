...
> = {
  about: {
    ...
    fields: [
      {
        label: "Bio",
        value: "I am a passionate UI/UX Designer…",
        type: "textarea",
      },
      { label: "Age", value: "26" },
  ...
  education: {
    ...
    fields: [
      ...
      { label: "Institution", value: "Dhaka University" },
      { label: "Passing Year", value: "2019" },
      { label: "Result", value: "3.80 / 4.00" },
    ],
  },
  religious: {
    title: "Edit Religious Overview",
    icon: ShieldCheck,
    color: "accent",
    fields: [
      { label: "Religion", value: "Islam" },
      { label: "Caste/Sect", value: "Sunni" },
      { label: "Religious Values", value: "Practicing" },
      { label: "Prayer", value: "5 Times a Day" },
    ],
  },
};
...
const educationInfo = [
  { label: "Degree", value: "BSc in Computer Science", icon: GraduationCap },
  { label: "Institution", value: "Dhaka University", icon: Book },
  { label: "Passing Year", value: "2019", icon: Calendar },
  { label: "Result", value: "3.80 / 4.00", icon: Star },
];

const religiousInfo = [
  { label: "Religion", value: "Islam", icon: ShieldCheck },
  { label: "Caste/Sect", value: "Sunni", icon: Users },
  { label: "Religious Values", value: "Practicing", icon: Heart },
  { label: "Prayer", value: "5 Times a Day", icon: CheckCircle2 },
];
...
<template>
  <div class="space-y-6 pb-12">
    ...
    >
      ...
      <div class="px-4 md:px-6 py-6 md:py-8 relative">
        <div class="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
          <!-- Floating Avatar -->
          <div class="relative group self-center md:self-auto shrink-0">
            <Avatar
              class="size-24 md:size-32 border-4 border-slate-50 dark:border-slate-800 shadow-xl"
            >
              <AvatarImage
                src="https://api.dicebear.com/7.x/avataaars/svg?seed=Rina"
              />
              <AvatarFallback
                class="bg-slate-100 dark:bg-slate-800 text-2xl font-bold text-slate-400"
                >RK</AvatarFallback
              >
            </Avatar>
            <button
              class="absolute bottom-1 right-1 p-2 rounded-xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-lg hover:scale-110 transition-transform"
            >
    ...
    <!-- Progress Card -->
    <Card
      class="border-none bg-gradient-to-r from-primary/5 via-secondary/5 to-accent/5 shadow-none overflow-hidden rounded-3xl"
    >
      <CardContent class="p-5 md:p-8">
        <div
          class="flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-12"
        >
          <div class="space-y-4 flex-1">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                <div
                  class="size-2 rounded-full bg-secondary animate-pulse"
                ></div>
                <h3
            ...
            >
              <Progress
                ...
                class="h-3 bg-secondary/10 dark:bg-secondary/5 rounded-full"
              />
            </div>
            <p class="text-sm text-slate-600 dark:text-slate-400 font-medium">
              Complete your
              <span class="text-secondary font-bold">family and education</span>
              details to reach 100% and unlock premium matches!
            </p>
          </div>
          <Button
            variant="secondary"
            class="rounded-2xl h-14 px-8 font-black bg-secondary hover:bg-secondary/90 text-white shadow-xl shadow-secondary/20 transition-all hover:scale-[1.02] active:scale-95 flex items-center gap-2"
          >
      ...
      >
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            >
              <CardTitle
                class="text-base font-bold flex items-center gap-2 justify-between"
              >
                <div class="flex items-center gap-2">
                  <div
        ...
        >
          ...
          <CardContent class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div
                v-for="info in educationInfo"
                :key="info.label"
                class="flex flex-col gap-3 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 hover:border-primary/20 transition-colors bg-slate-50/30 dark:bg-slate-800/10"
              >
                <div
                  class="size-10 rounded-xl bg-white dark:bg-slate-800 flex items-center justify-center shrink-0 border border-slate-100 dark:border-slate-700 shadow-sm"
                >
      ...
      >
        ...
        >
          ...
          <CardContent class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div
                v-for="info in religiousInfo"
                :key="info.label"
                class="flex items-start gap-4 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 hover:border-accent/20 transition-colors"
              >
                <div
                  class="size-10 rounded-xl bg-accent/5 flex items-center justify-center shrink-0 border border-accent/10"
                >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div class="flex items-center gap-3">
                  <div
                    ...
                    :class="{
                      'bg-primary/10':
                        modalConfig[activeModal].color === 'primary',
                      'bg-secondary/10':
                        modalConfig[activeModal].color === 'secondary',
                      'bg-accent/10':
                        modalConfig[activeModal].color === 'accent',
                    }"
                  >
                    <component
              ...
              <!-- Modal Body -->
              <div
                class="px-6 py-5 max-h-[60vh] overflow-y-auto space-y-4 scrollbar-none"
              >
                <div
